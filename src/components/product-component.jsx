...
const ProductComponent = ({ category, productName, price, imageUrl, id }) => {
  ...
  return (
    <div className="w-72 bg-white shadow-md rounded-md duration-500 hover:shadow-xl lg:scale-100 md:scale-90">
      <div className="overflow-hidden">
        <Link href={"/products/" + id}>
          <img
            src={URL_SERVER + imageUrl}
            alt="Product"
            className="w-65 object-cover scale-75 object-center rounded-md hover:scale-100 duration-500"
          />
        </Link>
      </div>
      <div className="px-4 w-72 rounded-b-md block overflow-hidden">
        ...
        <div className="flex items-center rounded-md mb-4 mt-2 justify-between z-40">
          <button
            ...
            className="flex p-3.5 py-2 bg-blue-200 rounded-l-lg text-md font-bold text-black justify-content-center justify-items-center hover:bg-red-400 z-40"
          >
          ...
          <Link href="/shopping-cart">
            <button
              ...
              className="flex px-3.5 py-2 bg-blue-200 rounded-r-lg text-md font-bold text-black justify-content-center justify-items-center hover:bg-green-400"
            >
